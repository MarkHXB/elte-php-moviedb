    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (count($_POST) !== 0) {
            ...
            if (!postKeyIsValid("plot")) {
                ...
                $errors[] = "Az ismertető maximum 1000 karakter hosszú lehet!";
            } else {
            ...
            if (count($errors) === 0) {
                //update db
                if(!$series->serieExist($data['title'])){
                    $data['episodes'] = [];
                    $series->addSerie($data);
                    header("Location: ../admin.php", true, 301);
                    die;
                }
                else{
                    $errors []= "Ilyen nevű sorozat már létezik az adatbázisban!";
                }
            }
        }
    }
                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Új sorozat hozzáadása</p>
                                        <div class="">
